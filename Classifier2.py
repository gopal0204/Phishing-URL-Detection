import pandas as pd
legitimate_urls = pd.read_csv("C:\Phishing-Website-Detection\extracted_csv_files\legitimate-urls.csv")
phishing_urls = pd.read_csv("C:\Phishing-Website-Detection\extracted_csv_files\phishing-urls.csv")
